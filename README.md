...
Atualmente trabalho com **análise de dados e automação de processos utilizando Python**, mas meu grande foco e paixão é o desenvolvimento de sistemas com **C#**. Tenho uma base sólida em tecnologias Web e estou sempre em busca de otimizar fluxos de trabalho através do código.
...
#### **Dados & Automação (Uso Profissional)**
<div style="display: inline_block">
